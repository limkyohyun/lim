  ...
  <div id="myCarousel" class="carousel slide" data-ride="carousel">
    ...
    <div class="carousel-inner">
      <div class="item active">
        <img src="/pro/image/돼지.jfif" alt="/pro/image/돼지.jfif" style="width:100%;">
      </div>

      <div class="item">
        <img src="/pro/image/스즈메의 문단속.jfif" alt="/pro/image/스즈메의 문단속.jfif" style="width:100%;">
      </div>
    
      <div class="item">
        <img src="/pro/image/파벨만스.jfif" alt="/pro/image/파벨만스.jfif" style="width:100%;">
      </div>
    </div>
